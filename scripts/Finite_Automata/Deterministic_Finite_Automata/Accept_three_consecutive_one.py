...
"""
__script_name__ = "DFA Accepting Three Consecutive 1s"
__version__ = "1.0.0"
...
if __name__ == "__main__":
    ...
    state_0 = DFAState(state_name='q0', final=False)
    state_1 = DFAState(state_name='q1', final=False)
    state_2 = DFAState(state_name='q2', final=False)
    state_3 = DFAState(state_name='q3', final=True)

    # defining transitions for all the states
    state_0.define_transition(zero=state_0, one=state_1)
    state_1.define_transition(zero=state_0, one=state_2)
    state_2.define_transition(zero=state_0, one=state_3)
    state_3.define_transition(zero=state_3, one=state_3)
