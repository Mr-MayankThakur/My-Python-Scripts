...
"""
__script_name__ = "DFA accepting string ending with 101"
__version__ = "1.0.0"
...
if __name__ == "__main__":
    ...
    state_0 = DFAState(state_name='q0')
    ...
    state_1.define_transition(zero=state_2, one=state_1)
    state_2.define_transition(zero=state_0, one=state_3)
    state_3.define_transition(zero=state_2, one=state_1)
